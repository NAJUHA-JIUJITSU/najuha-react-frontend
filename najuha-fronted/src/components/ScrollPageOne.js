  ...
  return (
    <>
      <div className="ScrollPageOne_wrapper">
        <img
          id={ScrollActive ? 'ScrollPageOne_back' : 'ScrollPageOne_gym-front'}
          src={gymFront}></img>
        ...
        <h1
          className={
            ScrollActive
              ? 'ScrollPageOne_ment1 ScrollPageOne_fadein'
              : 'ScrollPageOne_ment1 ScrollPageOne_fadeout'
          }>
          체육관에서
        </h1>
        <h1
          className={
            ScrollActive
              ? 'ScrollPageOne_ment2 ScrollPageOne_fadeout'
              : 'ScrollPageOne_ment2 ScrollPageOne_fadein'
          }>
          대회장까지
        </h1>
      </div>
      <div className="ScrollPageOne_wrapper">
        <img
          id="ScrollPageOne_competition-background"
          src={competitionBackgruond}></img>
      </div>
    </>
  )
}
